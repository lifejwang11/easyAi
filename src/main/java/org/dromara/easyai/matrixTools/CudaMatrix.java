...
public interface CudaMatrix {
	...
	// 矩阵数加
	void mathAdd(Matrix matrix, double nub) throws Exception;

	// 矩阵数减
	void mathSub(Matrix matrix, double nub) throws Exception;

	// 矩阵数乘
	void mathMul(Matrix matrix, double nub) throws Exception;

	// 矩阵数除
	void mathDiv(Matrix matrix, double nub) throws Exception;
}
