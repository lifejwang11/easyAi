...
public class CoverTest {
    ...
    public static void test(Operation operation) throws Exception {//识别桔梗或者土壤扰动
        ...
        Map<Integer, Double> point1 = operation.coverPoint(pic1, 5, 3);//获取覆盖率
        Map<Integer, Double> point2 = operation.coverPoint(pic2, 5, 3);//获取覆盖率
    ...
    public static void cover() throws Exception {
        ...
        for (int i = 1; i < 4; i++) {
            ...
            Matrix matrix1 = picture.getImageMatrixByLocal("/Users/lidapeng/Desktop/picture/a.jpg");
            Matrix matrix2 = picture.getImageMatrixByLocal("/Users/lidapeng/Desktop/picture/b.jpg");
            matrixMap.put(1, matrix1);
            matrixMap.put(2, matrix2);
            //poolSize 越大 识别速度越快，准确率相对变低，
            operation.coverStudy(matrixMap, 5, 3);
        }
